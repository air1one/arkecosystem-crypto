...
class Block {
    constructor({ data, transactions, id }, getBlockTimeStampLookup) {
        this.getBlockTimeStampLookup = getBlockTimeStampLookup;
        this.data = data;
    ...
    static getIdHex(data) {
        ...
        const payloadHash = serializer_1.Serializer.serialize(data);
    ...
    verifySignature() {
        const bytes = serializer_1.Serializer.serialize(this.data, false);
    ...
    verify() {
        ...
        try {
            ...
            if (crypto_1.Slots.getSlotNumber(this.getBlockTimeStampLookup, block.timestamp) >
                crypto_1.Slots.getSlotNumber(this.getBlockTimeStampLookup)) {
                result.errors.push("Invalid block timestamp");
            }
            const size = serializer_1.Serializer.size(this);
