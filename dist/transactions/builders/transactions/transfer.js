...
class TransferBuilder extends transaction_1.TransactionBuilder {
    constructor() {
        super();
        this.data.type = types_1.Two.TransferTransaction.type;
        this.data.typeGroup = types_1.Two.TransferTransaction.typeGroup;
        this.data.fee = types_1.Two.TransferTransaction.staticFee();
